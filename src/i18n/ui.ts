...
export const ui = {
  en: {
    // Navigation
    'nav.about': 'About',
    'nav.ethos': 'Ethos and Values',
    'nav.plans': 'Plans',
    'nav.contact': 'Contact',
    'nav.techniques': 'Our Techniques',

    // Hero
    'hero.tagline': 'Software for small businesses and their unique complexities',
    'hero.subtitle':
    ...
    // Ethos and Values
    'ethos.title': 'Our Ethos and Values',
    'ethos.intro': "We dig deep. We immerse ourselves in your company's problems with the goal of finding the simplest, most effective solution.",
    'ethos.value1.label': 'Partnership',
    'ethos.value1.body': "We are technical, but most of the time we are not specialists in your field. You know where the value is; we know how to improve process throughput, increase reliability, and make your company more robust and efficient. It's joint work — we complement each other.",
    'ethos.value2.label': 'Non-triviality',
    'ethos.value2.body': 'What you do is non-trivial — otherwise you would have already found software that does it.',
    'ethos.value3.label': 'Growth',
    'ethos.value3.body': 'We grow together.',
    'ethos.value4.label': 'Learning',
    'ethos.value4.body': 'We learn together.',
    'ethos.value5.label': 'Fairness & Commitment',
    'ethos.value5.body': "You are a small business, and so are we. There's nothing wrong with being small, but you have to have clarity of your goals and priorities. A software project is a commitment from both sides. As Dylan says: \"we'll let you be in our dreams if we can be in yours.\" We shall not refrain from pulling out of wavering partnerships.",
    'ethos.value6.label': 'Respect',
    'ethos.value6.body': 'We deeply respect our collaborations with clients, but we work <strong>with</strong> you, not <strong>for</strong> you.',
    'ethos.value7.label': 'Honesty',
    'ethos.value7.body': 'We reserve our right to tell you when we think you are wrong. We expect the same from you. Honest conversations are how we find the path that brings value to your company — and, as a byproduct, to Kukai as well.',
  ...
  pt: {
    // Navigation
    'nav.about': 'Sobre',
    'nav.ethos': 'Ethos e Valores',
    'nav.plans': 'Planos',
    'nav.contact': 'Contato',
    'nav.techniques': 'Nossas Técnicas',

    // Hero
    'hero.tagline': 'Software para pequenas empresas e suas complexidades únicas',
    'hero.subtitle':
    ...
    // Ethos and Values
    'ethos.title': 'Nosso Ethos e Valores',
    'ethos.intro': 'Nos aprofundamos. Mergulhamos nos problemas da sua empresa com o objetivo de encontrar a solução mais simples e eficaz.',
    'ethos.value1.label': 'Parceria',
    'ethos.value1.body': 'Somos técnicos, mas na maioria das vezes não somos especialistas na sua área. Você sabe onde está o valor; nós sabemos como melhorar o fluxo dos processos, aumentar a confiabilidade e tornar sua empresa mais robusta e eficiente. É um trabalho conjunto — nos complementamos.',
    'ethos.value2.label': 'Não trivialidade',
    'ethos.value2.body': 'O que você faz não é trivial — caso contrário, você já teria encontrado um software que o faça.',
    'ethos.value3.label': 'Crescimento',
    'ethos.value3.body': 'Crescemos juntos.',
    'ethos.value4.label': 'Aprendizado',
    'ethos.value4.body': 'Aprendemos juntos.',
    'ethos.value5.label': 'Justiça e Compromisso',
    'ethos.value5.body': 'Você é uma pequena empresa, e nós também. Não há nada de errado em ser pequeno, mas é preciso ter clareza sobre seus objetivos e prioridades. Um projeto de software é um compromisso de ambos os lados. Como diz Dylan: "vamos deixar você entrar em nossos sonhos se pudermos entrar nos seus." Não hesitaremos em sair de parcerias vacilantes.',
    'ethos.value6.label': 'Respeito',
    'ethos.value6.body': 'Respeitamos profundamente nossas colaborações com clientes. No entanto, frisamos que trabalhamos <strong>com</strong> você, não <strong>para</strong> você.',
    'ethos.value7.label': 'Honestidade',
    'ethos.value7.body': 'Reservamos nosso direito de dizer quando achamos que você está errado. Esperamos o mesmo de você. Conversas honestas são como encontramos o caminho que traz valor à sua empresa — e, como subproduto, à Kukai também.',
  ...
  es: {
    // Navigation
    'nav.about': 'Nosotros',
    'nav.ethos': 'Ethos y Valores',
    'nav.plans': 'Planes',
    'nav.contact': 'Contacto',
    'nav.techniques': 'Nuestras Técnicas',

    // Hero
    'hero.tagline': 'Software para pequeñas empresas y sus complejidades únicas',
    'hero.subtitle':
    ...
    // Ethos and Values
    'ethos.title': 'Nuestro Ethos y Valores',
    'ethos.intro': 'Profundizamos. Nos sumergimos en los problemas de su empresa con el objetivo de encontrar la solución más simple y efectiva.',
    'ethos.value1.label': 'Asociación',
    'ethos.value1.body': 'Somos técnicos, pero la mayoría de las veces no somos especialistas en su campo. Usted sabe dónde está el valor; nosotros sabemos cómo mejorar el rendimiento de los procesos, aumentar la confiabilidad y hacer su empresa más robusta y eficiente. Es un trabajo conjunto — nos complementamos.',
    'ethos.value2.label': 'No trivialidad',
    'ethos.value2.body': 'Lo que hace no es trivial — de lo contrario, ya habría encontrado un software que lo haga.',
    'ethos.value3.label': 'Crecimiento',
    'ethos.value3.body': 'Crecemos juntos.',
    'ethos.value4.label': 'Aprendizaje',
    'ethos.value4.body': 'Aprendemos juntos.',
    'ethos.value5.label': 'Equidad y Compromiso',
    'ethos.value5.body': 'Usted es una pequeña empresa, y nosotros también. No hay nada de malo en ser pequeño, pero debe tener claridad sobre sus objetivos y prioridades. Un proyecto de software es un compromiso de ambas partes. Como dice Dylan: "te dejaremos estar en nuestros sueños si podemos estar en los tuyos." No dudaremos en retirarnos de asociaciones vacilantes.',
    'ethos.value6.label': 'Respeto',
    'ethos.value6.body': 'Respetamos profundamente nuestras colaboraciones con los clientes, pero trabajamos <strong>con</strong> usted, no <strong>para</strong> usted.',
    'ethos.value7.label': 'Honestidad',
    'ethos.value7.body': 'Nos reservamos el derecho de decirle cuando creemos que está equivocado. Esperamos lo mismo de usted. Las conversaciones honestas son como encontramos el camino que aporta valor a su empresa — y, como subproducto, a Kukai también.',
